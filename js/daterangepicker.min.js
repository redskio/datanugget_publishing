 ...
 */
 !function(t, e) {
    ...
    var a = function(a, i, s) {
        ...
        "string" == typeof (i = e.extend(this.element.data(), i)).template || i.template instanceof e || (i.template = '<div class="daterangepicker"><div class="ranges"></div><div class="flex"><div class="drp-buttons"><div><span class="drp-selected"></span><span class="drp-select"></span></div></div><div class="drp-calendar left"><div class="calendar-table"></div><div class="calendar-time"></div></div><div class="drp-calendar right"><div class="calendar-table"></div><div class="calendar-time"></div></div> </div><div class="drp-buttons"><button class="cancelBtn" type="button"></button><button class="applyBtn" disabled="disabled" type="button"></button> </div></div>'),
    ...
    return a.prototype = {
        ...
        updateView: function() {
            ...
            this.endDate && this.container.find(".drp-selected").html(this.startDate.format(this.locale.format)),
            this.endDate && this.container.find(".drp-select").html(this.endDate.format(this.locale.format)),
            this.updateMonthsInView(),
        ...
        renderCalendar: function(a) {
            ...
            var w = i[1][1].format("YYYY.") + this.locale.monthNames[i[1][1].month()];
