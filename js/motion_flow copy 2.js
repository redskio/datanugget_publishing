...
const make_random_value = (min, max) => {
    ...
    return {[domain] : 
        { 
            ...
            direct_inflow: { 
                ...
                direct_inflow: (((temp1[0] + temp1[1] + temp1[2]) + temp2[1] + temp2[2]) * 4) + temp4
            },
            NAVER: { 
                step2_page1:{
                    step3_page: {
  ...
  let dump_data = make_dump_data('labbit');
    ...
    const update_step0_data = (index) => {
        ...
        // 초기값은 labbit
        console.log('step0_data[0][0][0] = ', step0_data[0][0][0]);
        /* step0_data[0][0][0].value_text = labbit_data.direct_inflow;
        step0_data[0][0][0].percent_text = labbit_data.direct_inflow.direct_inflow_value / (labbit_data.direct_inflow.direct_inflow_value + labbit_data.NAVER.NAVER_inflow + labbit_data.FACEBOOK.FACEBOOK_inflow + labbit_data.INSTAGRAM.INSTAGRAM_inflow + labbit_data.ETC)
        update_step0_data(0);
        console.log('step0_data[0][0][0].percent_text = ',step0_data[0][0][0].percent_text); */
